...
class ProductDesignController extends Controller
{
    ...
    {
        return Inertia::render('ProductDesigns/Index', [
            'items' => $this->model::with('product_type')->get(),
    ...
    {
        Validator::make($request->all(), $this->validateRules())->validateWithBag($this->bag);;
