<template>
    <div class="p-4">
        ...
        <Dialog v-model:visible="rowDialog" :style="{width: '450px'}" header="ข้อมูลแบบสินค้า" :modal="true"
                class="p-fluid">
            ...
            <template #footer>
                ...
                <Button label="Save" icon="pi pi-check" class="p-button-text" @click="saveRow"/>
            </template>
        </Dialog>
...
export default {
    ...
    methods: {
        ...
        saveRow() {
            ...
            if (!this.creating) {
                this.form.put(route('product-types.update', this.form.id), {
                    errorBag: 'typeBag',
                    preserveScroll: true,
                    onSuccess: () => {
                        this.$toast.add({
                ...
                this.form.post(route('product-types.store'), {
                    errorBag: 'typeBag',
                    preserveScroll: true,
                    onSuccess: () => {
                        this.$toast.add({
