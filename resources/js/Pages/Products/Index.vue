        ...
        <div class="w-full">
            <div class="sm:p-4">
                ...
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <!--                </select>-->
                    <!--            </search-filter>-->
                    <jet-button color="primary" @click="createProduct">
                        <span>สร้าง</span>
                        <span class="hidden md:inline">สินค้า</span>
                    </jet-button>
                </div>
                <div class="bg-white rounded-md shadow overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tr v-for="item in items" :key="item.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                            ...
                            <td class="border-t">
                                <inertia-link class="px-6 py-4 flex items-center" :href="route('products.edit', item.id)"
                                              tabindex="-1">
                                    {{ item.email }}
                                </inertia-link>
                            </td>
                            ...
                            <td class="border-t w-px">
                                <inertia-link class="px-4 flex items-center" :href="route('products.edit', item.id)" tabindex="-1">
                ...
                <create-product :show="showCreateModal" @close="showCreateModal=false"></create-product>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            ...
            sidebarItems: [
                {icon: '/icon/svg/download.svg', title: 'นำเข้า'}
            ]
        }
    },
    watch: {
