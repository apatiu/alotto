                            ...
                            <template #content>
                                <div class="w-60">
                                    ...
                                    <template v-if="$page.props.jetstream.hasTeamFeatures">
                                        ...
                                        <dropdown-link :href="route('stock-imports.index')">
                                            รับสินค้าเข้าสต้อก
                                        </dropdown-link>
                                        <dropdown-link :href="route('suppliers.index')">
                                            ผู้จำหน่าย
                                        </dropdown-link>
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <responsive-nav-link :href="route('profile.show')"
                                             :active="route().current('profile.show')">
                        Profile
                    </responsive-nav-link>


                    <responsive-nav-link :href="route('api-tokens.index')"
                    ...
                    <template v-if="$page.props.jetstream.hasTeamFeatures">
                        ...
                        <!-- Team Settings -->
                        <responsive-nav-link :href="route('teams.show', $page.props.user.current_team)"
                                                 :active="route().current('teams.show')">
                            Team Settings
                        </responsive-nav-link>

                        <responsive-nav-link :href="route('teams.create')"
...
<script>
    ...
    export default {
        name: "Navbar",
        components: {ResponsiveNavLink, DropdownLink, Dropdown, NavLink, JetApplicationMark},
        data() {
            return {
